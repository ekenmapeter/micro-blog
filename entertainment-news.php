...
<head>
    ...
    <title>Entertainment News - Get the latest business news around the world.</title>
...
<body>
    ...
    <div class="space-up container">
        <div>
            ...
            $totalRowsQuery = "SELECT COUNT(*) AS total FROM entertainment_articles WHERE status = 1";
