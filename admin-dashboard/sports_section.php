...
<html lang="en">
    ...
    <body>
        <?php include '../components/user-navbar.php'; ?>
         <?php include '../connections/sport_api.php'; ?>
        <div class="space-up">
            <div class="container" style="margin-top: 12px;">
                <h2 style="margin-bottom: 6px;">Add New Category </h2>
                    ...
                    <a href="#" class="read-more column button pad" style="padding: 14px;">Entertainment News</a>
                    <a href="business_section.php" class="read-more column button pad" style="padding: 14px;">Business News</a>
                    <a href="#" class="read-more column button pad" style="padding: 14px;">World News</a>
                  </div>
          </div>
