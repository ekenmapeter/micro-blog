...
try {
    ...
    // Check if the form is submitted
        ...
        if (isset($_GET['action']) && $_GET['action'] === 'publish' && isset($_GET['id'])) {
            ...
            $stmt = $pdo->prepare("UPDATE world_articles SET status = 1 WHERE id = :id");
            ...
            $titleStmt = $pdo->prepare("SELECT title FROM world_articles WHERE id = :id");
...
<body>
    ...
    <?php include '../connections/world_api.php'; ?>
    <div class="space-up">
